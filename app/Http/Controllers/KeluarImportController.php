...
class KeluarImportController extends Controller
{
    ...
    {
        $transaksis = TransaksiBarangModel::with(['items.barang', 'barang_keluar_customer'])->where('tipe_transaksi', 'keluar')->where('sumber_transaksi', 'import')->get();
        return view('after-login.keluar-import.index',compact('transaksis'));
    }
    public function create()
    {
        $barangs = BarangModel::all();
        return view('after-login.keluar-import.create', compact('barangs'));
    }
    public function edit($id)
    {
        ...
        return view("after-login.keluar-import.edit",compact('barangs','transaksi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('barang-import.keluar.index')->with('success', 'Data berhasil disimpan');
