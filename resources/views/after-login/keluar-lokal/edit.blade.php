        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Detail Transaksi Barang Keluar Lokal</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="nopol">Kode Barang</label>
                                <input type="text" class="form-control" id="nopol" placeholder="Kode Barang" />
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="form-group">
