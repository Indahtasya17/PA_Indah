                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_masuk" name="tanggal" required value="{{ $pelabuhan->tanggal }}"/>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Jumlah_container" name="jumlah_container"
                                        placeholder="Jumlah Container" value="{{ $pelabuhan->jumlah_container }}" required/>
                                </div>
                            </div>
